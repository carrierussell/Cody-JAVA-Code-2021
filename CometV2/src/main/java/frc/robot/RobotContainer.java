...
private final XboxController driveShoot = new XboxController(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("ShootBall", new ShootBall(m_shotMotor));
    SmartDashboard.putData("Intake", new Intake(m_shotMotor));
    SmartDashboard.putData("ReverseIn", new ReverseIn(m_shotMotor));
    ...
    m_chooser.setDefaultOption("AutoNav2", new AutoNav2(m_driveTrain));
    //Russell added code to try and add to the smartdashboard chooser:
    m_chooser.addOption("AutoNav1", new AutoNav1(m_driveTrain));
    m_chooser.addOption("AutoNav3", new AutoNav3(m_driveTrain));
...
reverseIntake.whileHeld(new ReverseIn(m_shotMotor) ,false);
    SmartDashboard.putData("Reverse Intake",new ReverseIn(m_shotMotor) );

final JoystickButton ballIntake = new JoystickButton(driveShoot, XboxController.Button.kX.value);        
ballIntake.whileHeld(new Intake(m_shotMotor) ,false);
...
shoot.whileHeld(new ShootBall(m_shotMotor) ,false);
    SmartDashboard.putData("Shoot",new ShootBall(m_shotMotor) );
